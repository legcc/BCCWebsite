...
<style lang="less" scoped>
    ...
    #background-container {
        ...
        bottom: 0;
        right: 0;
        background: url("~~assets/img/main_content/layouts/blueSky-bg.png") no-repeat;
    ...
    .practice_score {
        ...
        width: 120px;
        height: 90px;
        background: url("~~assets/img/main_content/exercise/score_bg.png") no-repeat;
        background-size: 100% 100%;
    ...
    .practice_speaking {
        ...
        width: 120px;
        height: 110px;
        background: url(~~assets/img/main_content/exercise/audio_speaking.png) no-repeat;
        ...
        &.active {
            ...
            line-height: 110px;
            font-size: 26px;
            background: url("~~assets/img/main_content/exercise/audio_speaking_active.png") no-repeat;
        }
    }
    ...
    .audio_start {
        ...
        width: 120px;
        height: 110px;
        background: url("~~assets/img/main_content/exercise/audio_play.png") no-repeat;
        background-size: 120% 120% !important;
        background-position: center center !important;
        cursor: pointer;
        opacity: 1;
        &.active {
            background: url("~~assets/img/main_content/exercise/audio_play_active.png") no-repeat;
        }
    }
    ...
    .audio_stop {
        ...
        width: 120px;
        height: 110px;
        background: url("~~assets/img/main_content/exercise/stop.png") no-repeat;
        background-size: 120% 120% !important;
        background-position: center center !important;
        cursor: pointer;
        opacity: 1;
    ...
    .footer-btn {
        ...
        margin: auto;
        z-index: 20;
        background: #20a0ff linear-gradient(lighten(#20a0ff, 10%) 0) no-repeat;
    ...
    .practice_nav_prev {
        background: url("~~assets/img/main_content/layouts/footer/practice_nav_prev.png") no-repeat;
        float: left;
    }

    .practice_nav_next {
        background: url("~~assets/img/main_content/layouts/footer/practice_nav_next.png") no-repeat;
        float: right;
    }
    ...
    .practice_nav_box .nav_progress_step_box .nav_progress_step {
        ...
        height: 60px;
        display: block;
        background: url("~~assets/img/main_content/layouts/footer/practice_nav_step.png") no-repeat;
        background-size: 100% 100%;
    }
