<template>
    <div id="cor-4-container">
        ...
        <contentContainer class="cc" :templates="templates" :notEntered="notEntered" :tools="tools"
...
<script>
    ...
    import R from 'ramda';
    import contentContainer from '~/components/course_4_header.vue';
        ...
        methods: {
            ...
            nextPage(e, pass) {
                if (pass) {
                    ...
                    this.templates[this.curPageIndex] && this.templates[this.curPageIndex]['template_no'] === 'K05' ? this.COMPARE(true) : this.COMPARE(false);
                }
            },
            activePage(data) {
                this.tools.isEndpage = false;
...
//                    如果下个路由相同则直接更改数据
            ...
            ...mapMutations('index/course/index', ['COMPARE']),
            /*拓展模块*/
//            进入模块函数
...
<style lang="less" scoped>
    ...
    #cor-4-container {
        ...
        min-height: 100%;
        overflow: hidden;
        background: url("~~assets/img/main_content/layouts/violetSky-bg.jpg") no-repeat;
    ...
    .course_right {
        ...
        .right-fctn {
            li {
                ...
                text-indent: -30px;
                &:nth-child(1) {
                    background: url("~~assets/img/main_content/course/l4-tools-1.png") center no-repeat;
                    background-size: contain;
                }
                &:nth-child(2) {
                    background: url("~~assets/img/main_content/course/l4-tools-2.png") center no-repeat;
                    background-size: contain;
                }
                &:nth-child(3) {
                    background: url("~~assets/img/main_content/course/l4-tools-3.png") center no-repeat;
                    background-size: contain;
                }
                &.exist {
                    color: white;
                    background: url("~~assets/img/main_content/course/l4-tools-active.png") center no-repeat;
                }
            }
        }
    }
    ...
    .practice_nav_box .progress-bar {
        position: relative;
        background: repeating-linear-gradient(-60deg, #4035DE, #4035DE 0.1rem, #5749E6 0, #5749E6 0.2rem);
        background-size: 100% 100%;
        border-radius: 3px;
    }
