...
<script>
    ...
    import contentContainer from '~/components/level_3_header.vue';
...
<style lang="scss" scoped>
    ...
    .sky-container {
        background: url("~~assets/img/main_content/layouts/bg-yellow.png") no-repeat;
        background-size: 100% 100%;
        padding-bottom: .5rem;
        position: relative;
        min-height: 100%;
    ...
    .practice_score {
        ...
        width: 240px;
        height: 230px;
        background: url("~~assets/img/main_content/exercise/nangua.png") no-repeat;
        background-size: 100% 100%;
    ...
    .audio_start {
        position: absolute;
        cursor: pointer;
        @include exerciseContainer((width:(100px), height:(100px)), 100px, 'bofang-yellow.png');
        left: 80px;
        top: 60%;
        transform: translateY(-50%);
        &.active {
    ...
    .practice_speaking {
        ...
        line-height: 100px;
        text-align: center;
        @include fullBgWithMainContentPicName('record-yellow.png');
        left: 80px;
        top: 80%;
        color: #692f13;
        font-size: 24px;
        ...
        &.active {
            ...
            @include fullBgWithMainContentPicName("bgr-yellow.png")
        }
    }
    ...
    .footer-btn {
        ...
        margin: auto;
        z-index: 20;
        background: #fc5c26 linear-gradient(#be9117 0, #be9117 100%) no-repeat;
    ...
    .books-logo {
        ...
        left: 2%;
        bottom: 30%;
        background: url("~~assets/img/main_content/exercise/books.png") no-repeat;
        background-size: 100% 100%;
        background-position: center;
    }
    ...
    .practice_nav_prev {
        background: url("~~assets/img/main_content/layouts/footer/nect_pre_yellow.png") no-repeat;
        float: left;
    }

    .practice_nav_next {
        background: url("~~assets/img/main_content/layouts/footer/nect_next_yellow.png") no-repeat;
        float: right;
    }
    ...
    .practice_nav_box .progress {
        ...
        *display: inline;
        ...
        height: 33px;
        display: inline-block;
        border: 3px solid #AC2C00;
        box-shadow: 2px 2px 2px #AC2C00 inset;
        background: linear-gradient(#AC2C00, #AC2C00);
        border-radius: 12px;
        overflow: visible;
    }
    ...
    .practice_nav_box .progress-bar {
        position: relative;
        background: repeating-linear-gradient(-60deg, #D5AE0B, #D5AE0B 2px, #DAA50F 0, #DAA50F 6px);
        background-size: 100% 100%;
        border-radius: 12px;
    ...
    .practice_nav_box .nav_progress_step_box .nav_progress_step {
        ...
        height: 70px;
        display: block;
        background: url("~~assets/img/main_content/layouts/footer/xiaonangua.png") no-repeat;
        background-size: 100% 100%;
    }
