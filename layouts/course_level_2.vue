...
<script>
    ...
    import R from 'ramda';
    import contentContainer from '~/components/course_2_header.vue';
        ...
        methods: {
            ...
            nextPage(e, pass) {
                if (pass) {
                    ...
                    if (this.templates[this.curPageIndex]['template_no'] === 'K05') {
                        this.COMPARE(true);
                    } else {
                        this.COMPARE(false);
                    }
...
<style lang="less" scoped>
    ...
    #cor-2-container {
        ...
        min-height: 100%;
        overflow: hidden;
        background: url("~~assets/img/main_content/layouts/baoqiang-bg.jpg") no-repeat;
    ...
    .course_right {
        ...
        .right-fctn {
            ...
            li {
                ...
                line-height: 42px;
                border-radius: 20px;
                background: linear-gradient(lighten(#E5EAE4, 10%) 0, #ACACAC 90%);
                cursor: pointer;
                color: #999999;
                font-size: 20px;
                margin-top: 30px;
    ...
    .practice_nav_box .progress-bar {
        position: relative;
        background: repeating-linear-gradient(-60deg, #28951c, #28951c 0.1rem, #0e2c14 0, #0e2c14 0.2rem);
        background-size: 100% 100%;
        border-radius: 3px;
    }
