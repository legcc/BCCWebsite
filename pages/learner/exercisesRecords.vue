...
<script>
    ...
    export default {
        async fetch({store, query, isServer, redirect}){
            ...
            await store.dispatch("index/learner/exercisesRecords/getData", {
                proId: query.proId || "0",
        ...
        methods: {
            ...
            ...mapActions('index/learner/exercisesRecords', [
                'searchTable'
            ])
        },
        computed: {
            ...mapState("index/learner/exercisesRecords", {
